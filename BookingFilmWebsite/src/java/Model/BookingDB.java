...
public class BookingDB {
    ...
    public static List<String> getBookingSeatIDsByBookingID(String bookingID) {
        ...
        String sql = "SELECT Distinct BookingSeatID FROM Booking_Seats WHERE BookingID = ?";
    ...
    public static List<BookingInfo> getBookingDetailsByUserID(String userID) throws SQLException {
        ...
        String query = "SELECT DISTINCT BookingID, BookingDate, TotalPrice FROM Tickets WHERE UserID = ?";
