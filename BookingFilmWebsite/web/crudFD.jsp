                                            ...
                                            <div class="container-fluid pt-5">
                                                ...
                                                <div class="row px-xl-5 pb-3">
                                                    <%
                                                        ...
                                                        List<FoodAndDrink> list = db.getAllCombos();
                                                        for (FoodAndDrink cb : list) {
                                                    %>
                                                    <div  class="col-lg-3 col-md-6 col-sm-12 pb-1">
                                                        <div class="card product-item border-0 mb-4">
                                                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                                                <img class="img-fluid w-100" src="<%= cb.getImagePath()%>" alt="">
                                                                <div class="overlay"> <!-- Thêm overlay -->
                                                                    ...
                                                                    <div class="icon-actions"> <!-- Action icons -->
                                                                        ...
                                                                        <a href="#deleteEmployeeModal"
                                                                           ...
                                                                           data-id="<%= cb.getComboID()%>">
                                                                            <i class="material-icons" data-toggle="tooltip" title="Delete" style="background-color: red;">&#xE872;</i></a></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
